...
from .user_serializer import (LoginSerializer, LoginUserSerializer, EmptySerializer, LogoutSerializer,
...
class ForgetPasswordView(APIView):
    ...
    def forget_email(user):
        ...
        send_email.delay(FORGET_PASSWORD_EMAIL_TEMP, [user.email], {"name": user.name, "url": url, "validity": PASSWORD_RESET_VALIDITY})
...
class EmployeeView(BaseView):
    ...
    def invitation_email(request, resp_data):
        ...
        context = {
            ...
            "url": f"{FRONTEND_BASE_URL}/invitation/{token}",
